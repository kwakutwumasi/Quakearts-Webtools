...
public class DataStoreListTest {
	...
	public void testFluidAPI() throws Exception {
		...
		dataStore.validateAll = true;
		List<ORMTestObject> list = generateListFilterUsingAll(dataStore)
			.thenList();
		
		assertThat(list.size(), is(3));

		Optional<ORMTestObject> optional = generateListFilterUsingAll(dataStore)
				.thenGetFirst();
		...
		list = generateListFilterUsingAny(dataStore)
			.thenList();
		
		assertThat(list.size(), is(3));

		optional = generateListFilterUsingAny(dataStore)
				.thenGetFirst();
	...
	protected ListBuilder<ORMTestObject> generateListFilterUsingAll(TestDataStore dataStore) {
		return dataStore.find(ORMTestObject.class)
			...
			.filterBy("testRangeBetween").withValues().between(1).and(2)
			.filterBy("testRangeBetweenNot").withValuesNot().between(1).and(2)
			.filterBy("testRangeFrom").withValues().startingFrom(1)
			.filterBy("testRangeFromNot").withValuesNot().startingFrom(1)
			.filterBy("testRangeTo").withValues().upTo(2)
			.filterBy("testRangeToNot").withValuesNot().upTo(2)
	...
	protected ListBuilder<ORMTestObject> generateListFilterUsingAny(TestDataStore dataStore) {
		return dataStore.find(ORMTestObject.class).usingAnyMatchingFilter()
			.filterBy("testValue").withAValueEqualTo("Test Value Any")
			.filterBy("testValueNot").withAValueNotEqualTo("Not Test Value Any")
			.filterBy("testVariable").withAValueLike("Test Variable Any")
			.filterBy("testVariableNot").withAValueNotLike("Not Test Variable Any")
			...
			.filterBy("testChoices").withAValueEqualToOneOf("Choice1 Any","Choice2 Any","Choice3 Any")
			.filterBy("testChoicesNot").withAValueNotEqualToOneOf("Choice1 Any","Choice2 Any","Choice3 Any")
			.useAResultLimitOf(3)
			.orderBy(property("testOrder1Any").descending(), 
					property("testOrder2Any").ascending());
	}
	...
	class TestDataStore implements DataStore {
		...
		private <Entity> List<Entity> list(Class<Entity> clazz, CriteriaMap criteriaMap) throws DataStoreException {
			if(validateAll) {
				...
				assertThat(criteriaMap.size(), is(13));
				assertThat(criteriaMap.containsKey(CriteriaMap.DISJUNCTION), is(false));
				...
				assertThat(((Range)criteriaMap.get("testRangeBetween")).getFrom(), is(1));
				assertThat(((Range)criteriaMap.get("testRangeBetween")).getTo(), is(2));
				...
				assertThat(((Range)((Not)criteriaMap.get("testRangeBetweenNot")).getValue()).getFrom(), is(1));
				assertThat(((Range)((Not)criteriaMap.get("testRangeBetweenNot")).getValue()).getTo(), is(2));
				...
				assertThat(((Range)criteriaMap.get("testRangeFrom")).getFrom(), is(1));
				...
				assertThat(((Range)((Not)criteriaMap.get("testRangeFromNot")).getValue()).getFrom(), is(1));
				
				assertThat(criteriaMap.containsKey("testRangeTo"), is(true));
				assertThat(criteriaMap.get("testRangeTo") instanceof Range, is(true));
				assertThat(((Range)criteriaMap.get("testRangeTo")).getTo(), is(2));
				...
				assertThat(((Range)((Not)criteriaMap.get("testRangeToNot")).getValue()).getTo(), is(2));
				...
				assertThat(criteriaMap.getOrder(), is(notNullValue()));
				assertThat(criteriaMap.getOrder().length, is(2));
				assertThat(criteriaMap.getOrder()[0].getProperty(), is("testOrder1Any"));
				assertThat(criteriaMap.getOrder()[0].isDescending(), is(true));
				assertThat(criteriaMap.getOrder()[1].getProperty(), is("testOrder2Any"));
				assertThat(criteriaMap.getOrder()[1].isAscending(), is(true));
				...
				assertThat(criteriaMap.containsKey("testValue"), is(true));
				assertThat(criteriaMap.get("testValue"), is("Test Value Any"));
				
				assertThat(criteriaMap.containsKey("testValueNot"), is(true));
				assertThat(criteriaMap.get("testValueNot") instanceof Not, is(true));
				assertThat(((Not)criteriaMap.get("testValueNot")).getValue(), is("Not Test Value Any"));
	
				assertThat(criteriaMap.containsKey("testVariable"), is(true));
				assertThat(criteriaMap.get("testVariable") instanceof VariableString, is(true));
				assertThat(((VariableString)criteriaMap.get("testVariable")).getValue(), is("Test Variable Any"));
	
				assertThat(criteriaMap.containsKey("testVariableNot"), is(true));
				assertThat(criteriaMap.get("testVariableNot") instanceof Not, is(true));
				assertThat(((Not)criteriaMap.get("testVariableNot")).getValue() instanceof VariableString, is(true));
				assertThat(((VariableString)((Not)criteriaMap.get("testVariableNot")).getValue()).getValue(), is("Not Test Variable Any"));
				...
				assertThat(criteriaMap.get("testChoices") instanceof Choice, is(true));
				assertThat(((Choice)criteriaMap.get("testChoices")).getChoices().size(), is(3));
				assertThat(((Choice)criteriaMap.get("testChoices")).getChoices().get(0), is("Choice1 Any"));
				assertThat(((Choice)criteriaMap.get("testChoices")).getChoices().get(1), is("Choice2 Any"));
				assertThat(((Choice)criteriaMap.get("testChoices")).getChoices().get(2), is("Choice3 Any"));
	
				assertThat(criteriaMap.containsKey("testChoicesNot"), is(true));
				assertThat(criteriaMap.get("testChoicesNot") instanceof Not, is(true));
				assertThat(((Not)criteriaMap.get("testChoicesNot")).getValue() instanceof Choice, is(true));
				assertThat(((Choice)((Not)criteriaMap.get("testChoicesNot")).getValue()).getChoices().size(), is(3));
				assertThat(((Choice)((Not)criteriaMap.get("testChoicesNot")).getValue()).getChoices().get(0), is("Choice1 Any"));
				assertThat(((Choice)((Not)criteriaMap.get("testChoicesNot")).getValue()).getChoices().get(1), is("Choice2 Any"));
				assertThat(((Choice)((Not)criteriaMap.get("testChoicesNot")).getValue()).getChoices().get(2), is("Choice3 Any"));
			}
