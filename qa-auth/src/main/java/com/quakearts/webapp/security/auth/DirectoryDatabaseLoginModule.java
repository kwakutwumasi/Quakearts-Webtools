...
public class DirectoryDatabaseLoginModule implements LoginModule{ 
    ...
    private static final Logger log = Logger.getLogger(DirectoryDatabaseLoginModule.class.getName());
        ...
        try{
            ...
            try {
                ...
                if(log.isLoggable(Level.FINE))
                    log.fine("Verifying username "+username);
            ...
            try{
                ...
                log.log(Level.SEVERE, "PreparedStatement could not be closed.");
            }
            try{
                con.close();
            }catch(Exception ex){
