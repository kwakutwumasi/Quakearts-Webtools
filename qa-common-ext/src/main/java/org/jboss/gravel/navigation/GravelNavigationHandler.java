...
public final class GravelNavigationHandler extends NavigationHandler {
    ...
    public GravelNavigationHandler(NavigationHandler wrapped){
    ...
    private class DefaultActionListener implements ActionListener, Serializable {
		...
		public void processAction(ActionEvent event)
	        ...
	        MethodExpression methodBinding = actionSource.getActionExpression();
	        ...
	        else
	        {
	            ...
	            try
	            {
	                outcome = (String) methodBinding.invoke(facesContext.getELContext(), null);
	            }
	            catch (ELException e)
	            {
