...
public class BootNav extends UIOutput {
	public static final String COMPONENT_FAMILY="com.quakearts.bootstrap.nav";
	public static final String RENDERER_TYPE="com.quakearts.bootstrap.nav.renderer";	
	...
	static{
		VALID_TYPES.put("none", "");
		VALID_TYPES.put("tabs", "");
		VALID_TYPES.put("pills", "");
		VALID_TYPES.put("bar", "");
	}
	...
	public String get(String attribute) {
		...
		if("type".equals(attribute) && attributeValue !=null)
