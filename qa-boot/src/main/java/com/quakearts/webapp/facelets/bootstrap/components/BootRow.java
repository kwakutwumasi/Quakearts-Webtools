...
public class BootRow extends UIOutput {
	public static final String COMPONENT_FAMILY="com.quakearts.bootstrap.bootrow";
	public static final String RENDERER_TYPE="com.quakearts.bootstrap.bootrow.renderer";
