...
public class DirectoryLoginModule implements LoginModule{
    ...
    */
    ...
    private static final Logger log = Logger.getLogger(DirectoryLoginModule.class);
	...
	public boolean login() throws LoginException {
        ...
        try {
            ...
            log.trace("Found DN "+loginDN);

            if(usecompare){
                log.trace("Comparing credentials.");
            ...
            } else
            {
                try {
                    ...
                    log.trace("Bound "+loginDN+" to ldap://"+ldapHost+":"+ldapPort);
            ...
            if ( e.getResultCode() == LDAPException.NO_SUCH_OBJECT ) {
                log.error("Error: No such entry.",e);
            } else if ( e.getResultCode() == LDAPException.NO_SUCH_ATTRIBUTE ) {
                log.error("Error: No such attribute",e);
            } else {
            ...
            try {
                ...
                log.error("Error disconnecting from LDAP server. ",e);
                e.printStackTrace();
            }
            loginDN = null;
            password = null;
